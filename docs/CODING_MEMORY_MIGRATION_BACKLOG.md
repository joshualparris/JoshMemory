...
| August app inventory (EliasApp, SylvieApp, Sleepy, Money, Books, Research, etc.) | QUEUED | Preserve project identities/relationships and only high-value durable history. |
